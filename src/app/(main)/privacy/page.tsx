  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        ...
        <p>
          Welcome to Numeraise. We respect your privacy and are committed to protecting your personal data. This privacy
        ...
        <p>
          We do not collect or store any of the financial data you input into our calculators. All calculations are
          performed directly in your browser. We may collect technical data (such as IP addresses, browser types, and
          usage data) via standard web analytics tools to improve our website.
        </p>

        <h2>3. Third-Party Services</h2>
        <p>
          We may use third-party advertising companies, such as Google AdSense, to serve ads when you visit our Website.
          These companies may use aggregated information (not including your name, address, email address, or telephone
          number) about your visits to this and other Web sites in order to provide advertisements about goods and
