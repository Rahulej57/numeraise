  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        ...
        <p>
          All calculators, tools, and written content provided on this website are for educational and informational
          purposes only. The results provided by our calculators are estimates and should not be construed as financial,
          legal, or tax advice.
        </p>
        ...
        <h2>4. Limitations</h2>
        <p>
          In no event shall Numeraise or its suppliers be liable for any damages (including, without limitation, damages
