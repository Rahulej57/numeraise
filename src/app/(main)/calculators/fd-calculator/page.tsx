  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        'A Fixed Deposit (FD) is a secure financial instrument offered by banks and non-banking financial companies (NBFCs). It provides investors a higher rate of interest than a regular savings account, until a given maturity date.',
    },
    {
      question: 'Is FD safe to invest?',
      answer:
        'Yes, FDs are considered one of the safest investment options. In India, deposits up to ₹5 Lakhs per bank are insured by the DICGC (a subsidiary of RBI).',
    },
    {
      question: 'How is FD interest calculated?',
      answer:
        'Most banks in India calculate FD interest using quarterly compounding. This means the interest generated in the first 3 months is added to your principal, and you earn interest on that combined amount for the next quarter.',
    },
    {
      question: 'Can I break my FD before maturity?',
      answer:
        'Yes, you can prematurely withdraw your FD. However, banks usually charge a penalty of 0.5% to 1% on the applicable interest rate for the period the deposit was actually held.',
    },
    {
      question: 'Is FD interest taxable?',
      answer:
        'Yes, interest earned on FDs is fully taxable according to your income tax slab. Banks will deduct TDS (Tax Deducted at Source) at 10% if your interest income exceeds ₹40,000 in a financial year (₹50,000 for senior citizens).',
    },
    {
      question: 'What is the difference between simple and compound FD?',
      answer:
        'Simple FDs pay out interest monthly or quarterly to your savings account. Cumulative (compound) FDs reinvest the interest, giving you a much larger lump sum at maturity.',
    },
    {
      question: 'Are Fixed Deposits risk-free?',
      answer:
        'In India, bank FDs are insured up to ₹5 Lakhs by DICGC. While they are essentially risk-free from default, they carry inflation risk if the interest rate is lower than inflation.',
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      ...
      <CalculatorContent>
        ...
        <p>
          A Fixed Deposit (FD) Calculator is an automated financial tool that helps you compute the exact maturity value
          and interest earned on your secure bank deposits. By inputting your deposit amount, the bank's offered
          interest rate, and your desired holding period, the calculator eliminates the need for complex manual
          compounding calculations.
        </p>
        <h2>How Does the FD Calculator Work?</h2>
        <p>
          In India, the vast majority of banks (such as SBI, HDFC, ICICI) compound fixed deposit interest{' '}
          <strong>quarterly</strong>. This means every three months, the interest you have earned is added back into
          your principal, increasing the base on which the next quarter's interest is calculated.
        </p>

        <h3>The Mathematical Formula for FD</h3>
        <p>
          Because of this quarterly compounding, the FD calculator uses the standard Compound Interest formula, adjusted
        ...
        <ul>
          <li>
            <strong>A:</strong> Maturity Amount (Principal + Total Interest)
          </li>
          <li>
            <strong>P:</strong> Principal Deposit Amount
          </li>
          <li>
            <strong>r:</strong> Annual Interest Rate (expressed in decimals, e.g., 7% = 0.07)
          </li>
          <li>
            <strong>n:</strong> Compounding Frequency per year (n = 4 for Quarterly)
          </li>
          <li>
        ...
        <p>
          Let's say you want to park your emergency fund of {format(200000 / 83)} in a secure FD for 3 years, and your
          bank is offering an interest rate of 7.00% p.a.
        </p>
        <ul>
          <li>
            <strong>Deposit (P):</strong> {format(200000 / 83)}
          </li>
          <li>
            <strong>Interest Rate (r):</strong> 7.00% (0.07)
          </li>
          <li>
            <strong>Tenure (t):</strong> 3 Years
          </li>
          <li>
            <strong>Compounding (n):</strong> 4 (Quarterly)
          </li>
        </ul>
        <p>
          By using the calculator, we determine that your total interest earned will be{' '}
          <strong>{format(46288 / 83)}</strong>. Therefore, your total maturity value after 3 years will be{' '}
          <strong>{format(246288 / 83)}</strong>.
        </p>

        <h2>Benefits of Fixed Deposits</h2>
        <p>
          <strong>Capital Protection:</strong> FDs are completely insulated from stock market volatility. If you invest{' '}
          {format(100000 / 83)}, your principal is 100% safe, making it the perfect instrument for emergency funds and
          short-term goals.
        </p>
        <p>
          <strong>Guaranteed Returns:</strong> Unlike <Link href="/calculators/mutual-fund-returns">mutual funds</Link>{' '}
          where returns fluctuate, you lock in the interest rate the moment you open the FD. You know exactly what your
          maturity amount will be on day one.
        </p>

        <h2>Common Mistakes to Avoid</h2>
        <p>
          <strong>Ignoring Inflation and Taxes:</strong> FD returns are fully taxable based on your income bracket. If
          inflation is 6% and your post-tax FD return is 5%, you are actually losing{' '}
          <Link href="/calculators/inflation-calculator">purchasing power</Link>. Never put long-term wealth creation
          money purely into FDs.
        </p>
        <p>
          <strong>Premature Withdrawal Penalties:</strong> If you break an FD before maturity, banks will typically
          reduce your applicable interest rate by 1%. If you are unsure when you need the money, it is better to open a
          sweep-in FD or a liquid mutual fund instead.
        </p>
      </CalculatorContent>
