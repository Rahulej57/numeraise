...
export const metadata: Metadata = {
  ...
  description:
    'Use our free SIP Calculator to estimate your future wealth, calculate mutual fund returns, and view detailed amortization schedules for your investments.',
  keywords: [
    'SIP calculator',
