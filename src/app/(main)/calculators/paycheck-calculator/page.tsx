...
export default function PaycheckCalculatorPage() {
  ...
  const taxLabels = useMemo(() => {
    switch (currency.code) {
      case 'INR':
        return {
          fed: 'Income Tax',
          state: 'Professional Tax (Est.)',
          social: 'EPF (Provident Fund)',
          deductions: 'Section 80C/Health',
          fedDef: 10,
          stateDef: 0.5,
          socialDef: 12,
        };
      ...
      case 'AUD':
        return {
          fed: 'Income Tax',
          state: 'Medicare Levy',
          social: 'Superannuation',
          deductions: 'Extra Super',
          fedDef: 25,
          stateDef: 2,
          socialDef: 11,
        };
      default:
        return {
          fed: 'Effective Federal Tax',
          state: 'State Tax Rate',
          social: 'FICA Tax (SS/Med)',
          deductions: 'Pre-Tax Deductions',
          fedDef: 12,
          stateDef: 4.5,
          socialDef: 7.65,
        };
  ...
  const shareUrl =
    typeof window !== 'undefined' ? `${window.location.origin}${window.location.pathname}?salary=${annualSalary}` : '';
  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        currency.code === 'USD'
          ? 'FICA stands for the Federal Insurance Contributions Act. It is a mandatory payroll tax in the United States that funds Social Security and Medicare. For employees, the rate is exactly 7.65% (6.2% for Social Security and 1.45% for Medicare).'
          : `This represents mandatory social contributions in your country (like National Insurance in the UK, EPF in India, or CPP in Canada) that fund retirement and healthcare programs.`,
    },
    {
    ...
    },
    {
      ...
      answer:
        "Most countries use a progressive tax system, meaning your income is taxed at different brackets (e.g. 10%, then 20%, then 30%). Your 'Effective Tax Rate' is simply the average percentage of your total income that you actually pay in taxes.",
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      ...
      <CalculatorContent>
        ...
        <p>
          A paycheck estimator is a tool that calculates your true "take-home pay" by subtracting all mandatory taxes
          and voluntary deductions from your gross salary. It helps employees understand exactly how much money will
          physically hit their bank account each pay period.
        </p>
        <h2>The Difference Between Gross Pay and Net Pay</h2>
        <p>
          When you sign an offer letter for a new job, the salary listed is your <strong>Gross Pay</strong>. This is the
          total amount of money the employer is paying you. However, you never actually see this full amount.
        </p>
        <p>
          Your <strong>Net Pay</strong> (or Take-Home Pay) is what is left over after the government and your benefits
          providers take their share. It is extremely important to build your personal budget based on your Net Pay, not
          your Gross Pay.
        </p>
        ...
        <ul>
          <li>
            <strong>
              Federal <Link href="/calculators/income-tax-calculator">Income Tax</Link>:
            </strong>{' '}
            Money sent directly to the US government to fund federal programs, defense, and infrastructure.
          </li>
          <li>
            <strong>State Income Tax:</strong> Money sent to your specific state. (Note: 9 states, like Texas and
            Florida, have 0% state income tax!)
          </li>
          <li>
            <strong>FICA (Social Security & Medicare):</strong> A flat 7.65% tax on your income that funds{' '}
            <Link href="/calculators/retirement-calculator">retirement</Link>
            and healthcare programs for seniors.
          </li>
          <li>
            <strong>Pre-Tax Deductions:</strong> Money you voluntarily withhold to pay for things like
            employer-sponsored <Link href="/calculators/health-insurance-calculator">Health Insurance</Link> premiums or
            contributions to your 401(k) retirement account.
          </li>
        </ul>
