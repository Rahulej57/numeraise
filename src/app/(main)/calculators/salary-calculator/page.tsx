...
export default function SalaryCalculatorPage() {
  ...
  const relatedCalcs = getRelatedCalculators('salary-calculator');
  return (
    <CalculatorLayout title="Salary Converter" description="" icon={calculatorIcon ?? undefined}>
            ...
            <CardContent className="p-0 lg:p-6 space-y-6">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="hpw" className="text-xs">
                      Hours / Week
                    </Label>
                    <Input
                      id="hpw"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="dpw" className="text-xs">
                      Days / Week
                    </Label>
                    <Input
                      id="dpw"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="hol" className="text-xs">
                      Holidays / Year
                    </Label>
                    <Input
                      id="hol"
              ...
              {!salaryData ? (
                ...
                <div className="divide-y">
                  ...
                  <div className="p-4 lg:p-6 flex justify-between items-center bg-muted border-t">
                    <span className="font-semibold uppercase tracking-wider text-sm text-muted-foreground">
                      Annually
                    </span>
                    <span className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-primary to-primary/60">
                      {salaryData.annual}
                    </span>
                  </div>
                </div>
      ...
      <CalculatorContent>
        ...
        <p>
          A salary calculator is an essential employment tool that converts your pay across different time periods.
          Whether you are paid hourly, daily, weekly, or annually, this tool instantly breaks down your income into all
          other equivalent frequencies. This is particularly crucial when comparing a salaried job offer to an hourly
          freelance contract.
        </p>
        <h2>How Does the Salary Converter Work?</h2>
        <p>
          This calculator relies on standard annualization math. By inputting your base pay amount, pay frequency, and
          your specific work schedule (hours per week, days per week, and holidays), the engine first calculates your
          total 'Annual Salary'. From that baseline, it divides the total back down into hourly, daily, weekly, and
          monthly equivalents.
        </p>
        ...
        <div className="bg-muted p-4 rounded-lg my-4 text-center font-mono">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            (Total Hours = [Weeks per year × Days per week - Holidays] × Hours per day)
          </p>
        </div>
        ...
        <ul>
          <li>
            <strong>Job Hunting:</strong> Instantly compare a $35/hour contract job against a $70,000/year salaried
            position to see which actually pays more.
          </li>
          <li>
            <strong>Budgeting:</strong> Convert your annual salary into exact bi-weekly or monthly take-home amounts to
            accurately plan your rent and expenses.
          </li>
          <li>
            <strong>Freelance Pricing:</strong> Determine exactly what you need to charge per hour as a freelancer to
            hit your target annual income goal.
          </li>
        </ul>
      </CalculatorContent>
      <FAQAccordion
        faqs={[
          {
            ...
            answer:
              'No, this calculator strictly converts Gross Salary (before taxes). To see exactly how much money you will take home after taxes, use our Income Tax Calculator.',
          },
          {
            question: 'How many working hours are in a standard year?',
            answer:
              'A standard full-time US working year is generally considered to be 2,080 hours (40 hours a week × 52 weeks). However, subtracting 10 standard public holidays drops this to 2,000 hours.',
          },
          {
            question: 'What is the difference between Bi-Weekly and Semi-Monthly?',
            answer:
              "Bi-Weekly means getting paid every two weeks (26 paychecks per year). Semi-Monthly means getting paid twice a month, usually on the 1st and 15th (24 paychecks per year). Bi-weekly paychecks are slightly smaller, but you get two 'extra' checks a year.",
          },
          {
            question: 'Are there 52 weeks in a year?',
            answer:
              'Actually, there are 52.14 weeks in a standard year (365/7). When calculating weekly salary perfectly accurately, you should divide the annual salary by 52.14.',
          },
          {
            question: 'Why are bi-weekly and semi-monthly pay periods different?',
            answer:
              'Bi-weekly means you get paid every two weeks (26 paychecks a year). Semi-monthly means you get paid twice a month, usually on the 1st and 15th (24 paychecks a year).',
          },
        ]}
      />

      <RelatedCalculators calculators={getRelatedCalculators('salary-calculator')} />
      <StructuredData
        type="Calculator"
        data={{
          name: 'Salary Calculator',
          description:
            'Convert your salary between hourly, weekly, monthly, and annual amounts to compare job offers and budget effectively.',
        }}
      />
    </CalculatorLayout>
  );
