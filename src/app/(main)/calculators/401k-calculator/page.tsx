  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        'A 401(k) is a retirement savings plan offered by many American employers that has tax advantages to the saver. The employee contributes part of their paycheck to an investment account before taxes are deducted. In many cases, the employer will match part of the contribution.',
    },
    {
      question: 'What is an Employer Match?',
      answer:
        'An employer match is free money. For example, if your employer offers a 50% match up to 6% of your salary, it means if you contribute 6% of your paycheck to your 401(k), your employer will put in an extra 3%. You should always try to contribute at least enough to get the full employer match!',
    },
    {
      question: 'What is a good rate of return to estimate?',
      answer:
        'Historically, the stock market (specifically the S&P 500) has returned an average of about 10% per year before inflation. Adjusting for inflation, a safe and common estimate for long-term planning is between 6% and 8%.',
    },
    {
      question: 'Can I withdraw my 401(k) early?',
      answer:
        'Generally, if you withdraw money from your 401(k) before age 59½, you will have to pay ordinary income tax on the amount plus a 10% early withdrawal penalty to the IRS.',
    },
    {
      question: 'What happens if I withdraw my 401(k) early?',
      answer:
        'If you withdraw funds before age 59½, you will generally be hit with a 10% early withdrawal penalty from the IRS, plus ordinary income tax on the amount withdrawn.',
    },
    {
      question: 'Is there a maximum I can contribute to my 401(k)?',
      answer:
        'Yes. For 2024, the IRS limit for employee contributions is $23,000. If you are 50 or older, you can make an additional catch-up contribution of $7,500.',
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      ...
      <CalculatorContent>
        ...
        <p>
          Our 401(k) calculator is designed to help you project exactly how much your{' '}
          <Link href="/calculators/retirement-calculator">retirement</Link> savings will grow over time, utilizing the
          power of compound interest, ongoing salary contributions, and the highly valuable "free money" from your
          employer's match program.
        </p>
        <h2>How Does a 401(k) Work?</h2>
        <p>
          A 401(k) is an employer-sponsored retirement account that allows an employee to dedicate a percentage of their
          pre-tax salary to a retirement account. These funds are invested in options like{' '}
          <Link href="/calculators/mutual-fund-returns">mutual funds</Link> or index funds.
        </p>

        <h3>1. Your Contributions</h3>
        <p>
          You choose a percentage of your salary (e.g., 10%) to be automatically deducted from your paycheck and
          deposited into your 401(k). Because these are pre-tax dollars, it actually lowers your taxable income for the
          year, saving you money on your income taxes.
        </p>

        <h3>2. The Employer Match</h3>
        <p>
          Many employers offer a matching contribution to encourage you to save. A common structure is a "50% match up
          to 6% of your salary." This means if you contribute 6% of your {currency.symbol}100,000 salary (
          {currency.symbol}6,000), your employer will put in an additional 3% ({currency.symbol}3,000) absolutely free.{' '}
          <strong>Always contribute at least enough to get the full employer match!</strong>
        </p>

        <h3>3. Compound Interest</h3>
        <p>
          The true magic of a 401(k) happens over decades. Every year, your investments generate returns (interest,
          dividends, and market growth). In the following years, you earn returns not just on your original money, but
          also on the returns you already earned. Over a 30-year career, the interest you earn will drastically outweigh
          the actual cash you deposited.
        </p>
