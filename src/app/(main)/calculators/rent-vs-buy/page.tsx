  ...
  return (
    <CalculatorLayout title="Rent vs Buy Calculator" description="Make the biggest financial decision of your life with mathematical certainty." icon={calculatorIcon ?? undefined}>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input type="number" value={(Number(propertyValue) * currency.rate).toFixed(0)} onChange={e => setPropertyValue((Number(e.target.value) / currency.rate).toString())} />
                </div>
                <div className="space-y-2">
                  <Label>Down Payment ({currency.symbol})</Label>
                  <Input type="number" value={(Number(downPayment) * currency.rate).toFixed(0)} onChange={e => setDownPayment((Number(e.target.value) / currency.rate).toString())} />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="number" value={propertyAppreciation} onChange={e => setPropertyAppreciation(e.target.value)} />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input type="number" value={(Number(currentRent) * currency.rate).toFixed(0)} onChange={e => setCurrentRent((Number(e.target.value) / currency.rate).toString())} />
                </div>
                <div className="space-y-2">
          ...
          {results ? (
            <div className="space-y-6">
                ...
                <CardContent className="p-6 md:p-8 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Over {tenure} years, {results.winner.toLowerCase()} generates {results.winnerValue} more wealth compared to the alternative.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                {/* Buy Card */}
                <Card className={`border-2 ${results.winner === "Buying" ? "border-emerald-500 shadow-emerald-500/10" : "border-border"} relative overflow-hidden`}>
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t border-dashed border-border/60 space-y-2">
                      ...
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="font-semibold text-emerald-600 dark:text-emerald-400">{results.finalPropertyValue}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                {/* Rent Card */}
                <Card className={`border-2 ${results.winner === "Renting" ? "border-emerald-500 shadow-emerald-500/10" : "border-border"} relative overflow-hidden`}>
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t border-dashed border-border/60 space-y-2">
                      ...
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="font-semibold text-emerald-600 dark:text-emerald-400">{results.rentNetWealth}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <CalculatorContent>
        ...
        <p>The "Rent vs. Buy" Calculator mathematically resolves the most fiercely debated topic in personal finance. Conventional wisdom states that "renting is throwing money away" and "buying a house is always the best investment." However, mathematically, this is often completely false. Buying a home involves massive unrecoverable costs (interest, property taxes, maintenance), while renting allows you to invest your down payment into the high-performing stock market.</p>
        
        <h2>How the Calculator Compares Both Paths</h2>
        <p>Our engine projects your total net worth at the end of the loan tenure using two parallel universes:</p>

        <h3>Universe 1: You Buy the House</h3>
        <p>You drain your savings for a down payment. You pay a heavy monthly EMI to the bank. Over 30 years, you pay double the house's value in interest alone. However, the physical property appreciates in value. Your final Net Wealth is the appreciated value of the fully paid-off house minus everything you spent on EMIs and the down payment.</p>

        <h3>Universe 2: You Rent & Invest</h3>
        <p>Instead of locking your savings in a down payment, you invest it in an index fund generating 10-12% annually. Because your monthly rent is usually much cheaper than a mortgage EMI, you take the monthly difference and aggressively invest that into the stock market too. Your final Net Wealth is the massive compounded value of your stock portfolio minus all the rent you paid over 30 years.</p>

        <h2>The Golden Rule: The 5% Rule</h2>
        <p>If you don't want to run a complex calculation, use the 5% Rule. Take the value of the home you want to buy and multiply it by 5%. Divide that by 12. If you can rent a similar home for less than that monthly amount, renting is mathematically superior to buying.</p>
      ...
      <FAQAccordion faqs={[
        {
          ...
          answer: "Yes, but buying a house with a mortgage is just renting money from the bank. When you rent an apartment, you pay the landlord for shelter. When you buy a house with a loan, you pay the bank massive amounts of interest for capital. Neither is 'free'."
        },
        {
          question: "Why does renting usually win over a 30-year period?",
          answer: "Because of compound interest. Real estate historically appreciates at 3-5% per year above inflation. The stock market historically returns 10-12%. While the homeowner builds equity slowly, the renter's stock portfolio compounds exponentially, often resulting in millions of dollars more in liquid wealth."
        },
        {
          question: "So I should never buy a house?",
          answer: "Not necessarily. Buying a house provides immense psychological security, forced savings for undisciplined people, and stability for a family. Just don't view your primary residence as your best financial investment. View it as a lifestyle choice that you are willing to pay a premium for."
        }
      ,
        {
          question: "What are the hidden costs of homeownership?",
          answer: "Beyond the mortgage EMI, homeowners must pay property taxes, home insurance, HOA/society fees, and continuous maintenance and repair costs, which renters do not pay."
        },
        {
          question: "Why do people say \"renting is throwing money away\"?",
          answer: "It is a misconception. Renting provides housing flexibility and frees up capital that would otherwise be locked in a down payment, allowing you to invest it in the stock market for potentially higher returns."
        }
      ]} />
      ...
      <RelatedCalculators calculators={getRelatedCalculators("rent-vs-buy")} /><StructuredData 
        type="Calculator" 
        data={{
          name: "Rent vs Buy Calculator",
          description: "Mathematically compare the net wealth of buying a home versus renting and investing the difference."
        }} 
      />
    </CalculatorLayout>
  );
