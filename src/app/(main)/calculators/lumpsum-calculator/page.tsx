  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        'A lumpsum investment is a single, one-time bulk investment made into a mutual fund, stock, or other financial instrument, as opposed to investing smaller amounts periodically (which is called an SIP).',
    },
    {
      question: 'Is Lumpsum better than SIP?',
      answer:
        'Lumpsum investments historically generate higher absolute returns over the very long term because the entire principal is subjected to compounding from Day 1. However, SIPs offer better risk mitigation by averaging out the cost of purchase during market volatility.',
    },
    {
      question: 'When is the best time to make a Lumpsum investment?',
      answer:
        'The ideal time to deploy lumpsum cash is during market corrections or crashes. Buying when the market is down allows you to acquire more units for the same amount of money, significantly boosting future returns.',
    },
    {
      question: 'Can I do both Lumpsum and SIP?',
      answer:
        'Absolutely! Many successful investors run regular monthly SIPs and use lumpsum investments to deploy annual bonuses or windfall gains into the same mutual fund folios during market dips.',
    },
    {
      question: 'How is Lumpsum calculated?',
      answer:
        'Lumpsum returns are calculated using the standard Compound Interest formula: A = P(1 + r/n)^(nt), where P is principal, r is the annual interest rate, and t is the time period in years.',
    },
    {
      question: 'Is it better to invest a lump sum or use SIP?',
      answer:
        'Mathematically, if the market goes up over the long term, investing a lump sum immediately yields higher returns. However, SIPs offer psychological comfort and protect against investing right before a market crash.',
    },
    {
      question: 'Can I withdraw my lump sum investment anytime?',
      answer:
        'It depends on the investment vehicle. Equity mutual funds have no lock-in (except ELSS which has 3 years). Fixed deposits usually have penalties for early withdrawal.',
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      ...
      <CalculatorContent>
        ...
        <p>
          A Lumpsum Calculator is an essential financial tool designed to estimate the future value of a one-time, bulk
          investment made today. Whether you have received an annual bonus, an inheritance, or proceeds from selling
          real estate, deploying a large sum of cash requires careful planning. This calculator helps you visualize how
          that single investment will grow over years or decades through the power of compounding.
        </p>
        <h2>How to Use the Lumpsum Calculator</h2>
        <p>To forecast your wealth creation, simply adjust the three sliders:</p>
        <ul>
          <li>
            <strong>Total Investment:</strong> The one-time amount you are ready to invest today.
          </li>
          <li>
            <strong>Expected Return Rate:</strong> Your realistic expectation of annual growth (e.g., 10-12% for equity
            <Link href="/calculators/mutual-fund-returns">mutual funds</Link>, 6-7% for debt funds).
          </li>
          <li>
            <strong>Time Period:</strong> The number of years you plan to leave the money invested without touching it.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>A:</strong> Total Future Value (Principal + Returns)
          </li>
          <li>
          ...
          <li>
            <strong>n:</strong> Number of times interest is compounded per year (Usually 1 for mutual funds)
          </li>
          <li>
            <strong>t:</strong> Total time period in years
          </li>
        </ul>

        <h3>Practical Example Scenario</h3>
        <p>
          Imagine you receive a performance bonus of {currency.symbol}50,000 and decide to invest it in an index mutual
          fund instead of buying a car. You expect a conservative 12% annual return over a 15-year holding period.
        </p>
        <ul>
          <li>
            <strong>Investment (P):</strong> {currency.symbol}50,000
          </li>
          <li>
            <strong>Expected Return (r):</strong> 12.00%
          </li>
          <li>
            <strong>Time Period (t):</strong> 15 Years
          </li>
        </ul>
        <p>
          Without adding any additional capital, the power of compounding will turn your initial {currency.symbol}50,000
          into <strong>{currency.symbol}273,678</strong>. Your money generated over {currency.symbol}223,678 in pure
          profit simply by staying invested over time!
        </p>

        <h2>SIP vs Lumpsum: The Eternal Debate</h2>
        <p>
          A common question is whether to invest a large amount immediately (Lumpsum) or stagger it over several months
          (<Link href="/calculators/sip-calculator">SIP</Link>). Mathematically, if the market is on a long-term upward
          trajectory, Lumpsum will almost always beat SIP because your entire capital starts earning returns from Day 1.
        </p>
        <p>
          However, Lumpsum carries higher <strong>timing risk</strong>. If you invest your entire capital the day before
          a 20% market crash, your portfolio immediately drops by 20%, and it may take years to recover. If you are
          extremely risk-averse, staggering a large windfall into 6-12 monthly SIPs (often via an STP - Systematic
          Transfer Plan) can provide psychological comfort during volatile markets.
        </p>

        <h2>Common Mistakes to Avoid</h2>
        <p>
          <strong>Panic Selling:</strong> Because lumpsum portfolios expose a large amount of capital to market
          volatility at once, it is common for new investors to panic when their portfolio shows a temporary 10-15%
          loss. Do not check your lumpsum portfolio daily. Invest and forget.
        </p>
        <p>
          <strong>Unrealistic Expectations:</strong> Do not expect a 25%{' '}
          <Link href="/calculators/cagr-calculator">CAGR</Link> simply because the market performed well last year.
          Always run your lumpsum calculations with conservative estimates (10-12% for equity, 6-7% for debt) to avoid
          disappointment when funding your financial goals.
        </p>
      </CalculatorContent>
