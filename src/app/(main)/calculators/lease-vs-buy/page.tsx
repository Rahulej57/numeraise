...
export default function LeaseVsBuyCalculatorPage() {
  ...
  const shareUrl = typeof window !== 'undefined' 
    ? `${window.location.origin}${window.location.pathname}?price=${carPrice}`
    : '';
  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: "To make an 'apples-to-apples' comparison, we must evaluate both options over the same time horizon. If you lease for 3 years, we calculate how much it costs to lease for 3 years, versus how much it would cost to buy the car, drive it for 3 years, and then sell it."
    },
    {
      question: "What is a Residual Value?",
      answer: "Residual value is the estimated value of the car at the end of the lease. If you buy a $30,000 car and the leasing company sets a 50% residual value for a 3-year lease, they are estimating the car will be worth $15,000 in 3 years. You only pay for the $15,000 of depreciation during your lease."
    },
    {
      question: "Is leasing always a bad financial decision?",
      answer: "Not always. While buying a slightly used car and driving it for 10 years is universally the cheapest option, if you are someone who buys a brand new car every 3 years anyway, leasing is often cheaper than buying and trading in because you avoid taking the massive initial depreciation hit yourself."
    },
    {
      question: "What is a Money Factor?",
      answer: "A Money Factor (often seen as something like 0.00250) is simply the dealership's way of expressing an interest rate on a lease. To convert a Money Factor to a standard Annual Percentage Rate (APR), simply multiply it by 2400. (e.g. 0.00250 * 2400 = 6% APR)."
    }
  ,
    {
      question: "Is leasing a car cheaper than buying?",
      answer: "Leasing offers lower monthly payments because you are only paying for the vehicle's depreciation during the lease term. However, buying is cheaper in the long run because you eventually own a driving asset with no monthly payments."
    },
    {
      question: "Can I customize a leased car?",
      answer: "Generally, no. You must return the car in its original condition. Any permanent modifications or severe wear-and-tear will result in heavy penalty charges at the end of the lease."
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      <div className="mb-6 text-center md:text-left">
        <h1 className="text-2xl md:text-4xl font-bold tracking-tight mb-2">Lease vs. Buy Calculator</h1>
      </div>
            ...
            <CardContent className="p-5 md:p-6 pt-0">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="p-3 md:p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  <p className="text-xs md:text-sm text-blue-600 dark:text-blue-400 font-medium mb-1">Buy Monthly Pmt</p>
                  <p className="text-xl md:text-2xl font-bold text-blue-600 dark:text-blue-400">{format(result.buyMonthlyPayment)}</p>
                ...
                <div className="p-3 md:p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                  <p className="text-xs md:text-sm text-emerald-600 dark:text-emerald-400 font-medium mb-1">Lease Monthly Pmt</p>
                  <p className="text-xl md:text-2xl font-bold text-emerald-600 dark:text-emerald-400">{format(result.leaseMonthlyPayment)}</p>
              ...
              {result.equityAtEnd > 0 && (
                <div className="p-4 bg-muted/50 rounded-lg border text-sm text-muted-foreground mb-6 text-center">
                  When buying, you gain <strong>{format(result.equityAtEnd)}</strong> in vehicle equity after {leaseTerm} months, which significantly offsets the higher monthly payments.
                </div>
              )}
      ...
      <CalculatorContent>
        ...
        <p>The decision to lease or buy a car is one of the most debated topics in personal finance. Dealerships often push leases because the monthly payment is lower, making it easier to sell you a more expensive car. However, a lower monthly payment does not always mean it is cheaper.</p>
        
        <h2>How the Calculation Works</h2>
        <p>To accurately compare leasing and buying, we have to look at the same time horizon (the length of the lease). Here is how the math breaks down:</p>

        <h3>1. The True Cost of Buying</h3>
        <p>When you buy a car, your monthly payments are higher because you are paying for the <em>entire</em> value of the car. However, after 3 years, you own a highly valuable asset. To find your "true cost," we calculate all the payments you made over 3 years, and then subtract the equity you built up in the car (its resale value minus your remaining loan balance).</p>

        <h3>2. The True Cost of Leasing</h3>
        <p>When you lease a car, you are only paying for the depreciation that occurs during those 3 years, plus a finance fee. Your monthly payments are lower, but at the end of the 3 years, you must return the car. You have zero equity. Your "true cost" is simply every dollar you spent during the lease.</p>

        <h2>When Leasing Makes Sense</h2>
        <p>Financially, buying a reliable car and driving it for 10 years is always the cheapest option. However, leasing can make sense if:</p>
        <ul>
          <li>You own a business and can write off the lease payments as a business expense.</li>
          <li>You insist on driving a brand new car every 3 years anyway. If you buy a new car and trade it in every 3 years, you are absorbing the worst part of the depreciation curve yourself, making it often more expensive than a subsidized lease.</li>
      ...
      <RelatedCalculators calculators={relatedCalcs} /><StructuredData 
        ...
        data={{
          ...
          description: "Compare the true financial cost of financing a car versus leasing it over the same time period."
        }} 
      />
