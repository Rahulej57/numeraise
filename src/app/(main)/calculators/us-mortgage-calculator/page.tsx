  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        'PITI stands for Principal, Interest, Taxes, and Insurance. It represents your true total monthly mortgage payment. Many basic calculators only show Principal and Interest, which tricks buyers into thinking they can afford a more expensive house than they actually can.',
    },
    {
      question: 'What is PMI (Private Mortgage Insurance)?',
      answer:
        'If you buy a house with a down payment of less than 20%, lenders consider you a higher-risk borrower. To protect themselves if you default on the loan, they force you to pay a monthly fee called PMI. This insurance protects the lender, not you. Once you have paid off enough of your loan to reach 20% equity, you can request to have PMI removed.',
    },
    {
      question: 'Are property taxes the same everywhere?',
      answer:
        'No. Property tax rates are set by local county and city governments to fund things like public schools, police, and roads. Some states like Texas and New Jersey have very high property taxes (over 2%), while others like Hawaii and Alabama have very low rates (under 0.5%).',
    },
    {
      question: 'Should I choose a 15-year or 30-year mortgage?',
      answer:
        'A 30-year mortgage gives you the lowest possible monthly payment, making the home more affordable month-to-month. A 15-year mortgage has a much higher monthly payment, but you will get a lower interest rate and pay drastically less total interest over the life of the loan.',
    },
    {
      question: 'What is Private Mortgage Insurance (PMI)?',
      answer:
        "If your down payment is less than 20% of the home's value, lenders require you to pay PMI. It protects the lender (not you) if you default on the loan.",
    },
    {
      question: 'What are closing costs?',
      answer:
        'Closing costs are fees paid at the end of a real estate transaction. They include origination fees, appraisal fees, title searches, and taxes, typically ranging from 2% to 5% of the loan amount.',
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      ...
      <CalculatorContent>
        ...
        <p>
          Most real estate websites provide a basic <Link href="/calculators/home-loan-calculator">mortgage</Link>{' '}
          calculator that only shows you the <strong>Principal and Interest (P&I)</strong>. This creates a massive
          problem for first-time homebuyers because it drastically underestimates the true cost of owning a home.
        </p>
        <p>
          Our US Mortgage Calculator calculates your true <strong>PITI</strong> (Principal, Interest, Taxes, and
          Insurance) to ensure you don't end up "house poor."
        </p>

        <h3>1. Principal and Interest (The Loan)</h3>
        <p>
          This is the actual repayment of the money you borrowed from the bank, plus the bank's fee (the interest rate).
          A 30-year fixed-rate mortgage is the standard in the US, meaning this portion of your payment will never
          change for 30 years.
        </p>

        <h3>2. Property Taxes (The Hidden Cost)</h3>
        <p>
          You have to pay taxes to your local government every single year based on the assessed value of your home. The
          average US property tax rate is around 1.1%, but it varies wildly. If you buy a {currency.symbol}500,000 home
          in New Jersey (2.4% tax rate), you will owe {currency.symbol}1,000 every single month just in property taxes!
        </p>

        <h3>3. Homeowners Insurance (Protection)</h3>
        <p>
          If you have a mortgage, your lender will legally require you to have homeowners insurance to protect the house
          from <Link href="/calculators/fire-calculator">fire</Link>, theft, and natural disasters. Like taxes, your
          lender will usually collect this money every month and pay the insurance company on your behalf through an
          escrow account.
        </p>

        <h3>4. Private Mortgage Insurance (The Penalty)</h3>
        <p>
          If you cannot afford a 20% down payment, lenders consider you a risky borrower. To protect themselves, they
          force you to pay Private Mortgage Insurance (PMI) every month. PMI provides absolutely zero benefit to you; it
          only pays the lender if you get foreclosed on. Once you have built up 20% equity in your home, you can
          petition your lender to cancel the PMI.
        </p>
