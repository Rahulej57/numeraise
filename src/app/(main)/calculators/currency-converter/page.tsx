  ...
  return (
    <CalculatorLayout title="Currency Converter - Live Exchange Rate Calculator" description="" icon={calculatorIcon ?? undefined}>
        ...
        <div className="lg:col-span-6 space-y-2 lg:space-y-6">
          <Card className="border-0 shadow-none bg-transparent lg:border lg:bg-card lg:shadow-sm">
            <CardContent className="p-0 lg:p-6 space-y-6">
              ...
              {loading && <div className="text-sm text-muted-foreground animate-pulse mb-4">Fetching live exchange rates...</div>}
              {error && <div className="text-sm text-amber-500 mb-4 bg-amber-500/10 p-2 rounded">Using approximate offline rates. Live API is currently unavailable.</div>}
              ...
              {convertedValue === null ? (
                ...
                <>
                  ...
                  <div className="mt-12 text-sm text-muted-foreground bg-muted/20 px-4 py-2 rounded-lg border border-border">
                    1 {fromCurrency} = {(rates[toCurrency] / rates[fromCurrency]).toLocaleString('en-US', { maximumFractionDigits: 6 })} {toCurrency}
                  </div>
                </>
              )}
            </CardContent>
      ...
      <CalculatorContent>
        ...
        <p>A currency converter is an essential financial tool that calculates the relative value of one country's currency against another in real-time. Because fiat currencies are traded 24/5 on the Foreign Exchange (Forex) market, their exact exchange rates fluctuate constantly based on global economic conditions, inflation rates, and geopolitical events.</p>
        
        <h2>How Does This Converter Work?</h2>
        <p>This calculator fetches live, up-to-date exchange rates directly from the European Central Bank via the Frankfurter API. When you select a base currency (like USD) and a target currency (like EUR), the engine pulls the latest official exchange ratio. It then multiplies your input amount by this ratio to give you an exact, real-time conversion.</p>

        <h3>The Conversion Mathematical Formula</h3>
        <p>The core logic behind currency conversion is simple multiplication, but it relies on an accurate exchange rate (ER):</p>
        ...
        <ul>
          <li><strong>International Travel:</strong> Instantly check how much your home currency is worth in your destination country so you know exactly what a hotel or meal costs.</li>
          <li><strong>E-Commerce & Freelancing:</strong> If you are buying a product priced in GBP with a USD credit card, or if you are a freelancer invoicing an international client, this tool prevents you from losing money on bad conversions.</li>
          <li><strong>Forex Trading & Remittances:</strong> Tracking exactly when it is most favorable to send money back to your home country based on daily rate fluctuations.</li>
        </ul>
      </CalculatorContent>
      <FAQAccordion faqs={[
        {
          question: "Why does my credit card or bank give me a worse exchange rate?",
          answer: "Our calculator shows the 'mid-market' or 'interbank' rate, which is the true official rate. Banks and credit card companies typically add a 1-3% markup (a spread) as a hidden fee when converting your money."
        },
        {
          question: "How often are the exchange rates updated?",
          answer: "The rates are fetched directly from the European Central Bank, which updates its official reference rates every working day around 16:00 CET."
        },
        {
          question: "Can I use this calculator when I am completely offline?",
          answer: "Yes! While you won't get live updates, if your internet connection drops, the calculator automatically falls back to a recent set of static rates so you can still do approximate conversions while traveling without Wi-Fi."
        }
      ,
        {
          question: "Why do banks charge a different rate than the calculator?",
          answer: "Our calculator uses the mid-market rate (the true global rate). Banks add a markup spread (usually 2-5%) to make a profit when exchanging your money."
        },
        {
          question: "What causes currency exchange rates to fluctuate?",
          answer: "Exchange rates are driven by supply and demand, which are influenced by inflation, interest rates, political stability, and a country's economic performance."
        }
      ]} />
      ...
      <RelatedCalculators calculators={getRelatedCalculators("currency-converter")} /><StructuredData 
        type="Calculator" 
        data={{
          name: "Live Currency Converter",
          description: "Convert USD, EUR, GBP, INR, and dozens of other global currencies instantly using live, up-to-date exchange rates."
        }} 
      />
    </CalculatorLayout>
  );
