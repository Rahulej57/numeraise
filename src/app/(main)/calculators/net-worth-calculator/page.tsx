...
export default function NetWorthCalculatorPage() {
  ...
  ].filter(d => d.value > 0), [cash, investments, retirement, realEstate, vehicles, otherAssets]);
  ...
  ].filter(d => d.value > 0), [mortgage, autoLoans, studentLoans, creditCards, otherDebt]);
  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: "Net worth is the value of all the non-financial and financial assets owned by an individual minus the value of all their outstanding liabilities (debts). It is the most accurate measure of your true financial health."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, absolutely. A negative net worth happens when your total debt exceeds your total assets. This is very common for recent college graduates who have high student loan debt but haven't had time to build up assets yet."
    }
  ,
    {
      question: "Is a primary residence included in net worth?",
      answer: "Yes, standard net worth calculations include the market value of your home as an asset, and the outstanding mortgage as a liability. However, \"Liquid Net Worth\" entirely excludes real estate."
    },
    {
      question: "What is a good net worth for my age?",
      answer: "A popular formula by Thomas Stanley (author of The Millionaire Next Door) is: (Age × Pre-Tax Annual Income) ÷ 10. If your net worth is higher than this number, you are doing well."
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
      <div className="mb-6 text-center md:text-left">
        <h1 className="text-2xl md:text-4xl font-bold tracking-tight mb-2">Net Worth Calculator</h1>
      </div>
          ...
          <Card className="border-border shadow-md bg-muted/40 border-none shadow-none h-full">
            ...
            <CardContent className="p-5 md:p-6 pt-0">
              <div className="text-center mb-6 mt-4">
                ...
                <h2 className={`text-4xl md:text-5xl font-extrabold tracking-tight ${netWorth < 0 ? 'text-rose-500' : 'text-primary'}`}>
                  {format(netWorth)}
                </h2>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="p-3 md:p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                  ...
                  <p className="text-base md:text-xl font-semibold text-emerald-600 dark:text-emerald-400">{format(totalAssets)}</p>
                </div>
                <div className="p-3 md:p-4 rounded-lg bg-rose-500/10 border border-rose-500/20">
                  ...
                  <p className="text-base md:text-xl font-semibold text-rose-600 dark:text-rose-400">{format(totalLiabilities)}</p>
                </div>
              </div>
      ...
      <CalculatorContent>
        ...
        <p>A Net Worth Calculator is the ultimate diagnostic tool for your personal finances. Unlike tracking your income or your monthly budget, your net worth provides a holistic, big-picture snapshot of your true financial health by balancing everything you own against everything you owe.</p>
        ...
        <p>Assets are anything that has a positive cash value that could theoretically be sold for cash. This includes:</p>
        <ul>
          <li><strong>Liquid Assets:</strong> Cash in your wallet, checking accounts, and savings accounts.</li>
          <li><strong>Investments:</strong> Brokerage accounts, mutual funds, stocks, bonds, and crypto.</li>
          <li><strong>Retirement Accounts:</strong> 401(k)s, IRAs, EPF, PPF, and pensions.</li>
          <li><strong>Real Estate:</strong> The current market value (not what you paid for it) of your primary residence and any rental properties.</li>
          <li><strong>Personal Property:</strong> The resale value of your cars, jewelry, and high-value collectibles.</li>
        </ul>

        <h3>2. Total Liabilities (What You Owe)</h3>
        <p>Liabilities are your debts—money that you are legally obligated to pay back to someone else. This includes:</p>
        <ul>
          <li><strong>Mortgages:</strong> The remaining principal balance on your home loan.</li>
          <li><strong>Installment Loans:</strong> Outstanding balances on auto loans and student loans.</li>
          <li><strong>Revolving Debt:</strong> Balances carried on credit cards or personal lines of credit.</li>
        </ul>

        <h2>Why Your Net Worth is More Important Than Your Income</h2>
        <p>Society often judges financial success by income (e.g., earning a "six-figure salary"). However, income is only half the equation. If you earn {currency.symbol}200,000 a year but spend {currency.symbol}200,000 a year on luxury cars, expensive rent, and vacations, you are generating massive cash flow, but your net worth remains zero.</p>
        <p>Conversely, someone earning {currency.symbol}60,000 a year who diligently saves, invests in index funds, and pays off their mortgage early can slowly build a net worth in the millions. Net worth is the true scorecard of wealth accumulation.</p>
      </CalculatorContent>
      ...
      <RelatedCalculators calculators={relatedCalcs} /><StructuredData 
        ...
        data={{
          ...
          description: "Calculate your true financial net worth by balancing your total assets against your total liabilities and debts."
        }} 
      />
