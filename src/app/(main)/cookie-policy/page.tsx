    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        ...
        <p>
          ...
          allow the website to recognize your device and remember if you have been to the website before.
        </p>

        <h2>How Numeraise Uses Cookies</h2>
        <p>
          Numeraise uses cookies primarily to enhance your experience and support our operations. We use the following
          types of cookies:
        </p>
        <ul>
          <li>
            <strong>Essential Cookies:</strong> These are required for the operation of our website, such as remembering
            your dark mode preference.
          </li>
          <li>
            <strong>Analytics Cookies:</strong> We use tools like Google Analytics to measure how users interact with
            our website content, which helps us improve our calculators.
          </li>
          <li>
            <strong>Advertising Cookies:</strong> We use third-party advertising partners, such as Google AdSense, who
