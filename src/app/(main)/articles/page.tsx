...
export const metadata: Metadata = {
  ...
  description: "Deep-dive guides, analysis and expert advice on investing, loans, taxes, and wealth creation. Free financial education by Numeraise.",
            ...
            <Link key={post.slug} href={`/articles/${post.slug}`} className="group">
              <Card className="h-full border border-border/50 bg-muted/20 hover:bg-muted/40 transition-all duration-300 shadow-none flex flex-col">
                <CardHeader className="p-5 flex-1 flex flex-col justify-between">
                  ...
                  <div className="text-xs text-muted-foreground mt-4 pt-4 border-t border-border/30 flex items-center justify-between">
